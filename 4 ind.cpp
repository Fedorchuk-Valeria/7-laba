...
int main()
{
    ...
    cout << "Ââåäèòå ïåðâîå ÷èñëî â ÷åòûðíàäöàòåðè÷íîé ñèñòåìå ñ÷èñëåíèÿ (c + èëè ñ -): ";
    cin >> sign1;
    gets(number1_14system);

    cout << "Ââåäèòå âòîðîå ÷èñëî â ÷åòûðíàäöàòåðè÷íîé ñèñòåìå ñ÷èñëåíèÿ (c + èëè ñ -): ";
    cin >> sign2;
    ...
    } else if (sign1 == '+' && sign2 == '-')
    {
        ...
        {
            if (sum1 >= sum2 && (number1_14system[0] - '0') > (number2_14system[0] - '0'))
            {
                cout << '+';
                subtraction_func(number1_14system, number2_14system, difference);
            } else
